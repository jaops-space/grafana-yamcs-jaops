...
func (client *YamcsClient) getParametersFetchMethod(instance string) types.FetchFunction[[]Parameter] {
	return func(ctx context.Context) ([]Parameter, string, error) {
		response := &mdb.ListParametersResponse{}
		err := client.HTTP.GetProtoWithContext(ctx, fmt.Sprintf("/mdb/%s/parameters", instance), response)
		if err != nil {
			return nil, "", err
		}
...
func (client *YamcsClient) GetParameter(ctx context.Context, instance Instance, parameter string) (Parameter, error) {
	response := &mdb.ParameterInfo{}
	err := client.HTTP.GetProtoWithContext(ctx, fmt.Sprintf("/mdb/%s/parameters/%s", instance.GetName(), parameter), response)
	if err != nil {
		return nil, err
	}
	return response, nil
...
func (client *YamcsClient) GetParameterRanges(ctx context.Context, instance Instance, parameter Parameter) (*pvalue.Ranges, error) {
	...
	err := client.HTTP.GetProtoWithContext(ctx, url, ranges)
	if err != nil {
		return nil, err
	}
	return ranges, nil
...
func (client *YamcsClient) getParameterHistoryFetchMethod(instance string, parameter string) types.FetchFunction[[]*pvalue.ParameterValue] {
	return func(ctx context.Context) ([]*pvalue.ParameterValue, string, error) {
		response := &archive.ListParameterHistoryResponse{}
		err := client.HTTP.GetProtoWithContext(ctx, fmt.Sprintf("/archive/%s/parameters/%s", instance, parameter), response)
		if err != nil {
			return nil, "", err
		}
...
func (client *YamcsClient) GetParameterValue(ctx context.Context, instance Instance, processor Processor, parameter Parameter) (ParameterValue, error) {
	...
	err := client.HTTP.GetProtoWithContext(ctx, fmt.Sprintf("/processors/%s/%s/parameters/%s", instance.GetName(), processor.GetName(), parameter.GetQualifiedName()), response)
	if err != nil {
		return nil, err
	}
	return response, nil
...
// GetParameter retrieves a specific parameter's value for a processor in a given instance.
func (client *YamcsClient) GetParameterValueByName(ctx context.Context, instance Instance, processor Processor, parameter string) (ParameterValue, error) {
	response := &pvalue.ParameterValue{}
	err := client.HTTP.GetProtoWithContext(ctx, fmt.Sprintf("/processors/%s/%s/parameters/%s", instance.GetName(), processor.GetName(), parameter), response)
	if err != nil {
		return nil, err
	}
	return response, nil
