...
GRAFANA_METRICS = {
    "time_to_panels_ready_ms": {
        "name": "Grafana Live - time to panels ready",
        "title": "Grafana Live - time to panels ready",
    ...
    "browser_heap_after_gc_bytes": {
        "name": "Grafana Live - browser heap after GC",
        "title": "Grafana Live - browser heap after GC",
    ...
    "backend_run_stream_runtime_ns": {
        "name": "Grafana Live - total backend RunStream runtime",
        "title": "Grafana Live - total backend RunStream runtime",
    ...
    "backend_median_heap_alloc_bytes": {
        "name": "Grafana Live - median backend live heap while panels stream",
        "title": "Grafana Live - median backend live heap while panels stream",
    ...
    "live_streams_opened": {
        ...
        "title": "Grafana Live - live streams opened",
