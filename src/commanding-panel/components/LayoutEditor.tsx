                ...
                >
                    ...
                    <Field label="Gap" description="px" style={{ marginBottom: 0 }}>
                        <Input
                            ...
                            onChange={(e) => onChange('layoutGap', Number(e.currentTarget.value))}
                        />
                    </Field>
                    ...
                    <Field label="Min width" description="px" style={{ marginBottom: 0 }}>
                        <Input
                            type="number"
                            min={0}
                            value={options.buttonMinWidth ?? 160}
                            onChange={(e) => onChange('buttonMinWidth', Number(e.currentTarget.value))}
                        />
                    </Field>
                    ...
                    <Field label="Min height" description="px" style={{ marginBottom: 0 }}>
                        <Input
                            type="number"
                            min={0}
                            value={options.buttonMinHeight ?? 40}
                            onChange={(e) => onChange('buttonMinHeight', Number(e.currentTarget.value))}
                        />
                    </Field>
