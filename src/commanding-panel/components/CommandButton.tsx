...
function getSideStyle(commandState: any, sideState: any, side: 'on' | 'off', activeState?: 'on' | 'off'): React.CSSProperties {
  ...
  return {
    ...
    backgroundImage: shape === 'svg' && customSVG ? `url("data:image/svg+xml;utf8,${encodeURIComponent(customSVG)}")` : undefined,
