    ...
    return (
        <PluginPage>
            ...
            <Alert title="Important" severity="info">
                For local instances of Yamcs (running at <code>localhost</code>) use <code>host.docker.internal</code>{' '}
                for Windows, and <code>172.17.0.1</code> for Linux, as the host path.
            </Alert>
