...
export const plugin = new PanelPlugin<ImagePanelOptions>(StaticImagePanel).setPanelOptions((builder) => {
    builder
        .addTextInput({
            name: 'Image URL',
            path: 'imageUrl',
            category: ['Image Source'],
            description: 'Static image URL used as the panel background or visual reference.',
        })
        .addSelect({
            name: 'Object Fit',
            path: 'objectFit',
